...
- **ESLint**: Tool for identifying and fixing problems in JavaScript code. (Version 9.14.0)
- **Prettier**: Tool for consistent code formatting. (Version 3.3.3)
...
1. Clone this repository:
   ```sh
   git clone https://github.com/seu-usuario/moments-adonis-api.git
   ```
...
- **ESLint**: Ferramenta para identificar e corrigir problemas no código JavaScript. (Versão 9.14.0)
- **Prettier**: Ferramenta para formatação consistente de código. (Versão 3.3.3)
